...
export function ApplePayButton({ onClick, className = '' }: ApplePayButtonProps) {
  return (
    <div 
      className={`inline-flex items-center justify-center bg-black text-white rounded-md px-4 py-2 h-10 cursor-pointer hover:bg-black/90 ${className}`}
      onClick={onClick || (() => console.log('Apple Pay clicked'))}
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="-76.79115 -52.55 665.5233 315.3" width="60" height="30" className="fill-white">
